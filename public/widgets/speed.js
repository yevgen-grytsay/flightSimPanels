	...
	render: function () {
		...
		Gauges.Widgets.Sequence()
			.add( this, function(done) {
				this.gauge = new Gauges.Widgets.StageImage("/assets/widget/speed/speed.png", this, { afterRender: done });
			} )
			.add( this, function(done) {
				this.dial = new Gauges.Widgets.StageImage("/assets/widget/speed/speed-dial.png", this, {
