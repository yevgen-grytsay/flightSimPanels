	...
	render: function () {
		...
		Gauges.Widgets.Sequence()
			.add( this, function(done) {
				this.disc = new Gauges.Widgets.StageImage("/assets/widget/turnslip/turnslip_disc.png", this, {
			...
			.add( this, function(done) {
				this.ball = new Gauges.Widgets.StageImage("/assets/widget/turnslip/turnslip_ball.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
			...
			.add( this, function(done) {
				this.gear = new Gauges.Widgets.StageImage("/assets/widget/turnslip/turnslip_gear.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
			...
			.add( this, function(done) {
				this.planeshape = new Gauges.Widgets.StageImage("/assets/widget/turnslip/turnslip_planeshape.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
			...
			.add( this, function(done) {
				this.inop = new Gauges.Widgets.StageImage("/assets/widget/turnslip/inop.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
