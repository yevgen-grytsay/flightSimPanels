	...
	render: function () {
		...
		Gauges.Widgets.Sequence()
			.add( this, function(done) {
				this.backplate = new Gauges.Widgets.StageImage("/assets/widget/attitude/attitude_backplate.png", this, {
			...
			.add( this, function(done) {
				this.disc = new Gauges.Widgets.StageImage("/assets/widget/attitude/attitude_disc.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
			...
			.add( this, function(done) {
				this.gear = new Gauges.Widgets.StageImage("/assets/widget/attitude/attitude_gear.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
			...
			.add( this, function(done) {
				this.planeshape = new Gauges.Widgets.StageImage("/assets/widget/attitude/attitude_planeshape.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
