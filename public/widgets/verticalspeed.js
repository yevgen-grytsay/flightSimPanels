	...
	render: function () {
		...
		Gauges.Widgets.Sequence()
			.add( this, function(done) {
				this.gauge = new Gauges.Widgets.StageImage("/assets/widget/verticalspeed/verticalspeed.png", this, { afterRender: done });
			} )
			.add( this, function(done) {
				this.dial = new Gauges.Widgets.StageImage("/assets/widget/verticalspeed/verticalspeed-dial.png", this, {
