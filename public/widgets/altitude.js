	...
	render: function () {
		...
		Gauges.Widgets.Sequence()
			.add( this, function(done) {
				this.gear = new Gauges.Widgets.StageImage("/assets/widget/altitude/altitude_gear.png", this, {
			...
			.add( this, function(done) {
				this.hatch = new Gauges.Widgets.StageImage("/assets/widget/altitude/altitude_hatch.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
			...
			.add( this, function(done) {
				this.dial_10000 = new Gauges.Widgets.StageImage("/assets/widget/altitude/altitude_dial_10000.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
			...
			.add( this, function(done) {
				this.dial_1000 = new Gauges.Widgets.StageImage("/assets/widget/altitude/altitude_dial_1000.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
			...
			.add( this, function(done) {
				this.dial_100 = new Gauges.Widgets.StageImage("/assets/widget/altitude/altitude_dial_100.png", this, {
					beforeRender: function(img) {
						img.bitmap.regX = 150;
						img.bitmap.regY = 150;
						img.bitmap.x = 150;
